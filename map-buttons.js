function onOpen() {
    PRE_DELIVERY_FORM_SHEET.sheet.getRange(PRE_DELIVERY_FORM_SHEET.exportCheckboxCell).setValue(false);
...
function installableOnEdit(e){
    var range = e.range;
    if(range.getSheet().getName() === PRE_DELIVERY_FORM_SHEET.sheet.getRange(PRE_DELIVERY_FORM_SHEET.exportCheckboxCell).getSheet().getName()
        && range.getA1Notation() === PRE_DELIVERY_FORM_SHEET.sheet.getRange(PRE_DELIVERY_FORM_SHEET.exportCheckboxCell).getA1Notation()
        && range.getValue() === true){
